...
import com.javatechie.service.ProductServiceV2;
...
public class ProductController {
    ...
    /*
      ...
      path = %KAFKA_HOME%/bin
      C:\kafka_2.13-3.8.1/config/zookeeper file
      dataDir=C:/kafka_2.13-3.8.1/config/zookeeper
      C:\kafka_2.13-3.8.1/config/server file
      log.dirs=C:/kafka_2.13-3.8.1/logs
      ----------------------------------------------------------------------
